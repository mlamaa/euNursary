            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Container(width: 5,),
                  Text("student",style: myTextStyle,),
                  Container(width: 5,),
                  Radio(
                    value: "student",
                    groupValue: group,
            ...
            Padding(
              ...
              child: InkWell(
                onTap: (){
                  ...
                  if(MessageTextController.text!=null&&TtileTextController.text!=null){
                    if(group=="class"){
                      if(CurrentStudentClass.name!=" "){
                        print("message: "+MessageTextController.text+" to class: "+CurrentStudentClass.ID);
                          dataBaseService.sendClassMessages(CurrentStudentClass.ID, MessageTextController.text,TtileTextController.text,context);
                          Navigator.pop(context);
                      }
                    }else if(group=="student"){
                      if(CurrentStudent.name!=" "){
                        print("message: "+MessageTextController.text+" to class: "+CurrentStudent.ParentEmail);
                        dataBaseService.sendStudentMessages(CurrentStudent.ParentEmail, MessageTextController.text,TtileTextController.text,context);
                        Navigator.pop(context);
                      }
                    }else{
                      dataBaseService.sendAllMessage(MessageTextController.text,TtileTextController.text,context);
                      Navigator.pop(context);
                    }
                  }
