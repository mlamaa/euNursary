          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(widget.Title,style: TextStyle(fontSize:30,color: MyColors.color1,fontWeight: FontWeight.bold),),
              ),
              Container(height: 5,),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(widget.Message,style: TextStyle(fontSize:20,color: MyColors.color1),),
              ),
