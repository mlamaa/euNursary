      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: InkWell(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>new AddClass(refresh:getClasses)));
              },
              child: Container(
                height: 30,
                ...
                child: Center(
                    child: Text("Add Class",style: TextStyle(color: Colors.white,fontSize: 20),)
                ),
              ),
            ),
          ),
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: (){
          ...
          new ClassStudents(ClassId: widget.ID,)));
        },
        child: Container(
          // height: 80,
          decoration: BoxDecoration(
          ...
          child: Center(
            child: Column(
              children: <Widget>[
                Container(height: 10,),
                Text(widget.ClassName,style: TextStyle(fontSize:25,color: MyColors.color1,fontWeight: FontWeight.bold),),
                Container(height: 10,),
                Text(widget.Year,style: TextStyle(fontSize:20,color: MyColors.color1),),
                Container(height: 10,),
                Row(
                  ...
                  children: <Widget>[
                    InkWell(
                      onTap: (){
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>
                        new UpdateClass(date: widget.Year,name: widget.ClassName,Id:widget.ID,refresh:widget.refresh,)));
                    ...
                    InkWell(
                      onTap: (){
                        ...
                        database.DeleteClass(widget.ID, widget.context,widget.refresh);
                      },
                      child: Container(
                          width: 35,
                          height: 35,
