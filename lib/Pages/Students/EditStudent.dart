...
class _EditStudentState extends State<EditStudent> {
  ...
  GetOldData() {
    ...
    dataBaseService.GetSingleStudent(widget.StudentId, context).then((value) {
      ...
      dataBaseService.GetSingleClass(value.data["class"], context)
          .then((value2) {
        if (value2 != null) {
          Classes OldClass =
              new Classes(value2.documentID, value2.data["ClassName"]);
          setState(() {
  ...
  EditStudentFunction() async {
    ...
    await dataBaseService.EdittStudentTODataBase(
            ThisClassMap,
                      ...
                      children: <Widget>[
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            if (StudentNameeController.text.length > 4 &&
                                CurrentParent.Email != " " &&
                                CurrentStudentClass.ID != " ") {
                              setState(() {
                                isAdding = true;
