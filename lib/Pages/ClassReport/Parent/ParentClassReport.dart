...
class _ParentClassReportState extends State<ParentClassReport> {
  ...
  GetAdminChildsClasses(String datee) async{
    await dataBaseService.GetSingleParents(UserCurrentInfo.Email,context).then((value) {
...
class SingleReportWidget extends StatefulWidget {
  ...
  SingleReportWidget({this.ReportSenderType,this.ReportSenderID,this.ReportId,this.ClassName,this.ClassId,this.Date,this.ReportSenderEmail });
